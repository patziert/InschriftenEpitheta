#Generiert Tabelle die zu allen Zuschreibungen ihr Vorkommen in den unterschiedlichen Statusgruppen zeigt
...
def main():
    ...
    for sheet in sheets:
        ...
        "ordo equester" : 0, 'ordo senatorius' : 0, "tituli sepulcrales" : 0}
    ...
    df.to_csv('./Ausgabetabellen/'+KORPUS+'_personenstatus.csv', index=True, quoting=1)
